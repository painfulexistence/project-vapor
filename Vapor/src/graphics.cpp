...
static int getNumFaces(const SMikkTSpaceContext* ctx) {
    auto mesh = static_cast<Vapor::Mesh*>(ctx->m_pUserData);
...
void Vapor::Mesh::initialize(const std::vector<Vapor::VertexData>& vertices, const std::vector<Uint32>& indices) {
...
void Vapor::Mesh::calculateTangents(){
...
void Vapor::Mesh::calculateLocalAABB(){
