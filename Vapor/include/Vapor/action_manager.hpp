...
namespace Vapor {
    ...
    class Timer {
    public:
        explicit Timer(float duration = 0.0f) : m_duration(duration), m_elapsed(0.0f) {
        }
    ...
    public:
        ...
        explicit CallbackAction(Callback callback) : m_callback(std::move(callback)) {
        }
    ...
    public:
        ...
        TimedCallbackAction(float duration, Callback callback) : m_timer(duration), m_callback(std::move(callback)) {
        }
    ...
    public:
        ...
        UpdateAction(float duration, UpdateFunc updateFunc) : m_timer(duration), m_updateFunc(std::move(updateFunc)) {
        }
    ...
    public:
        ...
        explicit UpdateForeverAction(UpdateFunc updateFunc) : m_updateFunc(std::move(updateFunc)) {
        }
    ...
    public:
        RepeatAction(std::shared_ptr<Action> action, int count = -1) : m_action(action), m_count(count) {
        }
