...
// History texture is RG16F: R = accumulated AO, G = view-space depth at the
// time the history was written. Disocclusion check: reproject the current
// world position into the previous view and compare against the stored depth.
kernel void computeMain(
    ...
    historyOut.write(float4(blended, viewZ, 0.0, 0.0), tid);
}
